...
public class TranslateTags {
	 ...
	 *            - The connection
	 * @param s
	 *            - The subject in the dbpediaasker.triple to match
	 * @param o
	 *            - The object in the dbpediaasker.triple to match
	 * @return - The predicate, if dbpediaasker.triple found
	 ...
	 * 
	 * @param s
	 *            - The subject of the sought after dbpediaasker.triple
	 * @param o
	 *            - The object of the sought after dbpediaasker.triple
	 * @return - The query
	 */
	 ...
	 *            - The number of questions that has at least one dbpediaasker.triple that
	 *            has a tag
	 * @param questionsDBpediaCovered
	 *            - The number of questions that has at least one dbpediaasker.triple who's
	...
	private static void printCoverage(int nbrOfQuestions,
		...
		try {
			...
			writer.println("Number of triples covered by Tags: "
					+ triplesTagCovered);
			writer.println("Tag dbpediaasker.triple coverage: "
					+ Math.round(triplesTagCovered / nbrOfTriples * 100) + "%");
			writer.println("Number of triples covered by DBpedia: "
					+ triplesDBpediaCovered);
			writer.println("DBpedia dbpediaasker.triple coverage: "
					+ Math.round(triplesDBpediaCovered / nbrOfTriples * 100)
					+ "%");
			writer.println();
			writer.println("Percentage of named entities extracted as part of a tagged dbpediaasker.triple: "
