package com.arclights.dbpediaasker.commons;
...
public class NamedEntity implements Comparable<NamedEntity> {
    ...
    /**
     * Adds dbpediaasker.triple that is related to the named entity
     *
     * @param t - The dbpediaasker.triple
     */
    ...
    /**
     * Removes a certain dbpediaasker.triple from the named entity
     *
     * @param t - The dbpediaasker.triple
     */
    ...
    /**
     * Creates a dbpediaasker.triple that links the named entity with the name of the named
     * entity
     *
     * @param labels - The labels from DBpedia
     */
